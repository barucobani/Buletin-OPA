 ...
 * ditangani di style.css (#a4doc[data-layout="..."]). `group` menentukan di
 * tab mana layout ini muncul: "buletin" (gaya laporan/formal) atau
 * "newsletter" (gaya newsletter grafis ala Canva). Menambah layout baru:
 * 1) tambahkan entri di sini (dengan group yang sesuai),
 * 2) tambahkan blok CSS baru untuk id tersebut di style.css.
